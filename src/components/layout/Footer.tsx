    ...
    <footer className="bg-primary-800 text-white">
      <Container className="py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Halaman */}
          <div>
            <h3 className="font-heading font-semibold text-lg mb-4">Perusahaan</h3>
            <ul className="space-y-2.5">
              {[
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              <li className="flex gap-3">
                <svg className="w-5 h-5 text-primary-300 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex gap-3">
                <svg className="w-5 h-5 text-primary-300 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="border-t border-white/10">
        <Container className="py-6">
          <p className="text-center text-sm text-slate-400">
            &copy; {new Date().getFullYear()} {siteConfig.companyName}. Seluruh hak cipta dilindungi.
          </p>
        </Container>
      </div>
    </footer>
