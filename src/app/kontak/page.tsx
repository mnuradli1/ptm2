...
export const metadata: Metadata = {
  title: "Kontak",
  description: "Hubungi PT Persada Teknologi Mandiri untuk konsultasi solusi IT. Tersedia via telepon, email, dan WhatsApp.",
};
...
export default function KontakPage() {
  return (
    <>
      <PageHeader
        title="Hubungi Kami"
        subtitle="Tim kami siap membantu kebutuhan teknologi informasi Anda"
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">{siteConfig.operatingHours}</p>
                  </div>
                </div>
              </div>
